const Back = () => {
    return (
      <div
        ...
        style={{
          backgroundImage: `url('src/components/portfolio-4/Kitchen-Portfolio-Header.png')`,
        }}
      >
  
        {/* Centered Text */}
        <div className="relative flex items-center justify-center h-full">
          <h1 className="text-white text-5xl md:text-7xl font-bold">Portfolio-4</h1>
        </div>
      </div>
    );
  };
...
const Photos = () => {
  const images = [
    "src/components/portfolio-4/IMG-20230324-WA0020.jpg",
    "src/components/portfolio-4/IMG-20230324-WA0021.jpg",
    "src/components/portfolio-4/IMG-20230324-WA0024.jpg",
    "src/components/portfolio-4/IMG-20230324-WA0026.jpg",
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <Slider {...mainSettings}>
        <div className="p-2">
          <img 
            src="src/components/portfolio-4/Kitchen-1-scaled.jpeg" 
            alt="Slide 1"
        ...
        <div className="p-2">
          <img 
            src="src/components/portfolio-4/Kitchen-2-scaled.jpeg" 
            alt="Slide 2"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-4/Kitchen-3-scaled.jpeg" 
            alt="Slide 3"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-4/Kitchen-5-scaled.jpeg" 
            alt="Slide 4"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-4/Kitchen-6-scaled.jpeg" 
            alt="Slide 5"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
