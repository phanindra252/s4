    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="mb-24">
        ...
        <div className="flex justify-between items-center gap-8">
          <img
            src="src/components/home/Sutton-Council.svg"
            alt="Sutton"
            className="h-12 object-contain"
          />
          <img
            src="src/components/home/Group-8260.svg"
            alt="Croydon"
            className="h-16 object-contain"
          />
          <img
            src="src/components/home/Bromley-Approved.svg"
            alt="Bromley"
            className="h-16 object-contain"
          />
          <img
            src="src/components/home/home-Build.webp"
            alt="Home & Build"
            className="h-12 object-contain"
          />
        </div>
