const Back = () => {
    return (
      <div
        ...
        style={{
          backgroundImage: `url('src/components/kitchen/roam-in-color-z3QZ6gjGRt4-unsplash-2048x1365.jpg')`,
        }}
      >
  
        {/* Centered Text */}
        <div className="relative flex items-center justify-center h-full">
          <h1 className="text-white text-5xl md:text-7xl font-bold">Kitchen</h1>
        </div>
      </div>
    );
  };
    ...
    return (
      <div className="flex w-full h-[600px]">
        ...
        <div className="w-1/2 relative overflow-hidden">
          ...
          <img
            src="src/components/kitchen/Kitchen.png"
...
const Kitchenrenovations = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 space-y-6 grid grid-cols-2">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        {/* Design Process */}
        <div className="space-y-4">
            <img src='src/components/kitchen/1.png' />
          <p className="text-gray-600 leading-relaxed">
        ...
        {/* Craftsmanship */}
        <div className="space-y-4">
        <img src='src/components/kitchen/2.png' />
          <p className="text-gray-600 leading-relaxed">
  ...
  export  {Back, Modern, Ourspecialist, Kitchenrenovations};
