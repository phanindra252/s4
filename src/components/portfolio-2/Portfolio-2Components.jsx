const Back = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url('src/components/portfolio-2/Portfolio-2-header-1.png')`,
      }}
    >

      {/* Centered Text */}
      <div className="relative flex items-center justify-center h-full">
        <h1 className="text-white text-5xl md:text-7xl font-bold">Portfolio-2</h1>
      </div>
    </div>
  );
};
...
const Photos = () => {
  const images = [
    "src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.52.12-PM.jpeg",
    "src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.52.13-PM-1.jpeg",
    "src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.52.13-PM-2.jpeg",
    "src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.52.13-PM.jpeg",
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <Slider {...mainSettings}>
        <div className="p-2">
          <img 
            src="src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.47.10-PM.jpeg" 
            alt="Slide 1"
        ...
        <div className="p-2">
          <img 
            src="src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.47.11-PM-3.jpeg" 
            alt="Slide 2"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.47.11-PM-4.jpeg" 
            alt="Slide 3"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.47.12-PM-1.jpeg" 
            alt="Slide 4"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-2/WhatsApp-Image-2022-12-29-at-12.47.12-PM-2.jpeg" 
            alt="Slide 5"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
