const Back = () => {
    return (
      <div
        ...
        style={{
          backgroundImage: `url('src/components/portfolio-1/Portfolio-Header-2-1.png')`,
        }}
      >
  
        {/* Centered Text */}
        <div className="relative flex items-center justify-center h-full">
          <h1 className="text-white text-5xl md:text-7xl font-bold">Portfolio-1</h1>
        </div>
      </div>
    );
  };
...
const Photos = () => {
  const images = [
    "src/components/portfolio-1/Staircase-1300x1300.jpg",
    "src/components/portfolio-1/Bathroom-2-1300x1300.jpg",
    "src/components/portfolio-1/Corridor-1300x1300.jpg",
    "src/components/portfolio-1/Floor-1300x1300.jpg",
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <Slider {...mainSettings}>
        <div className="p-2">
          <img 
            src="src/components/portfolio-1/IMG_7944-HDR-3-scaled.jpg" 
            alt="Slide 1"
        ...
        <div className="p-2">
          <img 
            src="src/components/portfolio-1/IMG_7979-HDR-10-scaled.jpg" 
            alt="Slide 2"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-1/IMG_8009-HDR-16-scaled.jpg" 
            alt="Slide 3"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-1/IMG_8014-HDR-17-scaled.jpg" 
            alt="Slide 4"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
        <div className="p-2">
          <img 
            src="src/components/portfolio-1/IMG_8034-HDR-21-scaled.jpg" 
            alt="Slide 5"
            className="w-full h-[400px] object-cover rounded-lg" 
          />
        </div>
...
export {Back, RenovationHeader, Photos, RenovationFooter, SyncedSlider, SuccessStory};  